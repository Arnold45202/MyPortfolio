  ...
  return (
    <div>
      ...
      <section>
        ...
        <p>
        So, it might sound a bit wild, but coding wasn't my first go-to. Initially, I thought about diving<br /> into the whole med scene because, 
        you know, all my friends were into it. 
        But one day, reality hit,  <br /> and I realised I didn't actually want to be a doctor. <br />  <br />
      ...
      <section>
        <h2>What are some fun facts about me</h2>
        <p>
