  ...
  return (
    <div>
      <div className="project-container">
        ...
        <div className="project-box">
          <a href="https://weather-pal-frontend.vercel.app/" target="_blank" rel="noopener noreferrer" className='Project-title'><img className='gamePicture' src="https://cdn.discordapp.com/attachments/949224467127746610/1206151642286919800/image.png?ex=65daf740&is=65c88240&hm=8448ab4b73aad1cc15c2bd97d709e7b55b240fe291f7010fd3db0acceca7b56f&" alt="Project Image" /></a>
          <div className="project-details">
            <h2 className="project-title"><a href="https://weather-pal-frontend.vercel.app/" target="_blank" rel="noopener noreferrer" className='Project-title'>WeatherPal</a></h2>
            <h2 className='second-title'>Tech Stack: React, javascript, CSS, MongoDB, Express, Nodejs and more.</h2>
            ...
            <a href="https://github.com/Arnold45202/WeatherPal/tree/main" target="_blank" rel="noopener noreferrer" className='github-logo'>
              <GitHubIcon />
            </a>
          </div>
        </div>
