    ...
    <div>
      <div className="project-container">
        ...
        <div className="project-box">
          ...
          <div className="project-details">
            <h2 className="project-title"><a href="https://arcadegamedown.000webhostapp.com/index.html" target="_blank" rel="noopener noreferrer" className='Project-title'>My Portfolio</a></h2>
            ...
            <a href="https://github.com/Arnold45202/Games" target="_blank" rel="noopener noreferrer" className='bottom'>
              <GitHubIcon />
            </a>
          </div>
        </div>
